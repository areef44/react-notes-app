...
// Mengubah notes menjadi array langsung, bukan fungsi
let notes: Note[] = [
  {
    id: 1,
    title: "Babel",
...
// Fungsi untuk menampilkan tanggal dengan format yang diinginkan
...
function archivedNote(id: number): void {
...
function unArchivedNote(id: number): void {
  notes = notes.map((note) => {
    if (note.id === id) {
